...
(function () {
  ...
  const NAV_CONFIG = [
    {
      id: 'operaciones',
      label: 'Operaciones',
      pages: ['/schedule.html', '/fleet.html', '/messages.html', '/operations.html', '/marine-conditions.html', '/operational-center.html', '/bookings.html'],
      items: [
        { label: 'Bookings / Reservaciones', href: '/bookings.html',             icon: '📑', testid: 'nav-bookings' },
    ...
    },
    {
      id: 'finanzas',
      label: 'Finanzas',
      pages: ['/reports.html', '/accounting.html', '/commissions.html', '/expenses.html'],
      items: [
        { label: 'Gastos',                href: '/expenses.html',                       icon: '💰', testid: 'nav-expenses' },
        ...
        { label: 'Cuadre Contable',       href: '/accounting.html?tab=cuadre-booking',  icon: '⚖️', testid: 'nav-cuadre-booking' },
        { label: 'Cuadre Legacy',         href: '/accounting.html?tab=legacy-cleanup',  icon: '🗂️', testid: 'nav-legacy-cleanup' },
        { label: 'Control de Periodo',    href: '/accounting.html?tab=period-control',  icon: '🔒', testid: 'nav-period-control' },
        { label: 'Conciliación Bancaria', href: '/accounting.html?tab=reconciliation',  icon: '🔀', testid: 'nav-conciliacion' },
        { label: 'Análisis Ingresos',     href: '/accounting.html?tab=ingresos-analisis', icon: '📈', testid: 'nav-ingresos' },
        { label: 'Análisis Gastos',       href: '/accounting.html?tab=gastos-analisis', icon: '📉', testid: 'nav-gastos' },
        ...
        { label: 'Depósitos',             href: '/accounting.html?tab=deposits',        icon: '🧾', testid: 'nav-depositos' },
      ]
    },
    {
      id: 'comercial',
  ...
  function buildCmdPal() {
    const pages = [
      ...
      { label: 'Bookings / Reservaciones',   href: '/bookings.html',                          icon: '📑', cat: 'Operaciones' },
      ...
      { label: 'Cuadre Contable',           href: '/accounting.html?tab=cuadre-booking',      icon: '⚖️', cat: 'Finanzas' },
      { label: 'Cuadre Legacy',             href: '/accounting.html?tab=legacy-cleanup',      icon: '🗂️', cat: 'Finanzas' },
      { label: 'Control de Periodo',        href: '/accounting.html?tab=period-control',      icon: '🔒', cat: 'Finanzas' },
      { label: 'Conciliación Bancaria',     href: '/accounting.html?tab=reconciliation',      icon: '🔀', cat: 'Finanzas' },
      { label: 'Análisis Ingresos',         href: '/accounting.html?tab=ingresos-analisis',   icon: '📈', cat: 'Finanzas' },
      { label: 'Análisis Gastos',           href: '/accounting.html?tab=gastos-analisis',     icon: '📉', cat: 'Finanzas' },
